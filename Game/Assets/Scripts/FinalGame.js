...
function OnGUI()
{
	...
	if(grid.state == GridState.INGAME)
	{
		GUI.Box(Rect(Screen.width-100, 10, 100, 20), "Pizza: "+ numPizza);
		if (GUI.Button(Rect(20, 20, 50, 30), "Retry")){
			Application.LoadLevel(Application.loadedLevel);
		}
			if (GUI.Button(Rect(20, 50, 50, 30), "Quit")){
